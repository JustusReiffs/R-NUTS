...
- The first part, which is written by Justus Reiffs </br>
- The second part, which is written by Jan Pinto Strohhäusl </br>

We will now start with the part written by Justus Reiffs, which will be followed by the part which was written by Jan Pinto Strohhäusl.


-- hier Text von Justus einfügen --



# Part 2: Jan Pinto Strohhäusl
